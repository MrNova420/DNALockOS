...
"""
DNA-Key Authentication System - Messaging Module

Optional ZMQ-based messaging with graceful fallbacks for platforms
where pyzmq is not available or cannot be compiled.
"""

__version__ = "0.1.0"

from server.messaging.zmq_client import (
    create_zmq_client,
    is_zmq_available,
    ZMQClient,
    NoOpClient,
...
__all__ = ["create_zmq_client", "is_zmq_available", "ZMQClient", "NoOpClient"]
