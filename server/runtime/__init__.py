...
"""
DNA-Key Authentication System - Runtime Module

Platform-aware runtime utilities including event loop setup,
...
__all__ = ["install_best_event_loop", "get_platform_info"]
